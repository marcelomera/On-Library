  ...
  if (isset($_GET["act"]))
  {
      ...
      else if ($_GET["act"]=="login")
      {
       ...
       if (isset($_POST["btnLogar"]))
       {
           ...
           //$comandoSql = "SELECT count(*) FROM usuarios WHERE user_email = '$email' AND user_senha = '$senha' AND user_status = 1";
            $comandoSql = "SELECT * FROM usuarios WHERE user_email = '$email' AND user_senha = '$senha' AND user_status = 1";
           //echo "<script> alert ('$comandoSql') </script>";
           //exit;
...
<!--********************************************************************************************************************
                    INICIO FORMATAÇÃO SCRIPT MENU SCROLL
*********************************************************************************************************************-->
...
<div id="home" class="contentbox">
    ...
    <div id="form_pesquisa">
        <form method="GET" id="search_index" name="search_index" action="#">
            <fieldset id="pesquisa_index"><legend id="Lpesq">Pesquise nosso Acervo:</legend>
            <p id="busca"><input type="text" name="bPesq" id="iPesq"
                                 maxlength="50" size="15" placehold="Faça Sua Busca"/></p><p id="bEnviar">
                <input type="submit" value="Buscar" name="tEnviar"              id="iEnviar"/></p>
        </fieldset>
        </form>
    </div>
    ...
    <div id="carrossel-topo">
        <ul>
            ...
            <li>
                <img src="_imagens/03-hq.jpg"/>
                <p>Para a bibliotecária Nazaré Góes, trabalhar rodeada desses títulos é uma viagem no tempo. “Estou há 23 anos aqui e tudo me remete ao passado. Infelizmente, desde que entrei obras já se perderam, mas o que temos hoje é um tesouro. Aqui sei que consigo um mundo de informações que podem ajudar muita gente. Recebemos pessoas de outros países, vez ou outra, para fazer pesquisas. Eles conhecem mais esse lugar do que quem mora aqui”, comenta.</p>
            </li>

            <li>
                <img src="_imagens/biblioteca-01.jpg"/>
                <p>Para a bibliotecária Nazaré Góes, trabalhar rodeada desses títulos é uma viagem no tempo. “Estou há 23 anos aqui e tudo me remete ao passado. Infelizmente, desde que entrei obras já se perderam, mas o que temos hoje é um tesouro. Aqui sei que consigo um mundo de informações que podem ajudar muita gente. Recebemos pessoas de outros países, vez ou outra, para fazer pesquisas. Eles conhecem mais esse lugar do que quem mora aqui”, comenta.</p>
            </li>
...
<div id="multimidia" class="contentbox">
    <div id="video">
    ...
    <![endif]-->
    <div id="upCorpo">
    <a id="upHome" href="#" onclick="return false;" onmousedown="resetScroller('myheading');">
        HOME</a>
    </div>
    <div class="clear"></div>
</div>
