...
<head>
    <meta charset="UTF-8">
    <title>On-Library - Funcionário</title>

    <!-- CSS Code -->

    <link rel="stylesheet" href="_css/_cadastroFuncionario/admin.css" />
    ...
    <link rel="stylesheet" href="_css/_cadastroFuncionario/estilo_funcionario.css" />
...
<div id="home" class="contentbox">
    ...
    <nav>
        ...
        <ul id="myheading">
            ...
            <li><a href="perfil_funcionario.php">ADMIN</a></li>
    ...
    <!--FIM MODAL CADASTRO FUNCIONÁRIO-->
<!--********************************************************************************************************************
    ...
    <footer>
        ...
        <aside id="lado-baixo">
            ...
            <p><label for="cMsg">Fale Conosco: </label></p>
                <p><textarea name="tMsg" id="cMsg" cols="52" rows="10" placeholder="DEIXE SUA MENSAGEM AQUI!"></textarea>
